...
relationships:
  derived_from: null
  related_to: [REQM-ARCH-005, REQM-ARCH-006]
---
...
Requirements are source-controlled documents owned by the user. Accidental writes would corrupt version history and undermine the git-native versioning model defined in REQM-ARCH-006.
